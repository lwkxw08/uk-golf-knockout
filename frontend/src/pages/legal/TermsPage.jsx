  ...
  return (
    <div>
      ...
      <div className="prose prose-green max-w-none space-y-6 text-gray-700 dark:text-gray-300">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white">3. Account Registration</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white">4. Tournament Participation</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white">5. Code of Conduct</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white">6. Payments</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white">11. Governing Law</h2>
