    ...
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm border text-center">
          ...
          <p className="text-2xl font-bold text-gray-900">\u00a3{(data.stats.totalEarnedPence / 100).toFixed(2)}</p>
        ...
        <div className="space-y-4">
          {[
            ...
            <div key={item.step} className="flex gap-3 items-start">
              <div className="w-8 h-8 rounded-full bg-green-100 text-green-700 font-bold flex items-center justify-center flex-shrink-0 text-sm">
                {item.step}
              </div>
