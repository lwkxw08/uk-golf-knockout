    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${navBg}`}>
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between h-16 items-center">
          <Link to="/" className={`flex items-center gap-2.5 font-bold text-lg ${textColor} transition`}>
            <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${scrolled ? 'bg-green-700' : 'bg-white/20 backdrop-blur'}`}>
